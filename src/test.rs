...
test!(test_short_circuit_or3, "BEGIN { print (0 || 4) }", ONE_LINE, "1\n", 0);
test!(test_short_circuit_and, "BEGIN { print (0 && (4/0)) }", ONE_LINE, "0\n", 0);
test!(test_short_circuit_and2, "BEGIN { print (123 && 5) }", ONE_LINE, "1\n", 0);
test!(test_short_circuit_and3, "BEGIN { print (123 && 0) }", ONE_LINE, "0\n", 0);